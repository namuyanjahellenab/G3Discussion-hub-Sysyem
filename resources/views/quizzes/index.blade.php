...
<div class="dashboard-grid-container" id="clean-dashboard-root">
    <div class="sidebar-panel">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{ route('quizzes.index') }}"><i class="fa-regular fa-file-lines"></i> Quizzes</a></li>
    ...
    <div class="content-workspace">
        <div style="margin-bottom: 2rem;">
            <p style="text-transform: uppercase; color: #667085; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.5px; margin: 0 0 4px 0;">Assessment</p>
            <h1 style="letter-spacing: -0.5px; color: #101828; font-size: 2rem; font-weight: 700; margin: 0;">QUIZZES</h1>
        </div>

        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; margin-bottom: 24px;">
            <div class="dashboard-group-card"><h5 style="font-weight:700;">Available quizzes</h5><div style="font-size:1.4rem; color:#0d52cc;">{{ $quizzes->count() }}</div></div>
            <div class="dashboard-group-card"><h5 style="font-weight:700;">Completed quizzes</h5><div style="font-size:1.4rem; color:#0d52cc;">{{ $completed->count() }}</div></div>
            <div class="dashboard-group-card"><h5 style="font-weight:700;">Upcoming quizzes</h5><div style="font-size:1.4rem; color:#0d52cc;">{{ $upcoming->count() }}</div></div>
            <div class="dashboard-group-card"><h5 style="font-weight:700;">Scores</h5><div style="font-size:1.4rem; color:#0d52cc;">{{ $scores->sum('Score') }}</div></div>
        </div>
