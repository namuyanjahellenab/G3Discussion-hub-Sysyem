...
<style>
    .dashboard-grid-container { display: grid !important; grid-template-columns: 1fr 340px !important; min-height: 100vh !important; width: 100% !important; background-color: #fcfcfd !important; font-family: 'Inter', sans-serif !important; }
...
<div class="dashboard-grid-container" id="clean-dashboard-root">
    ...
    <div class="content-workspace">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; margin-bottom: 24px;">
            <div class="card" style="padding: 20px;"><h5 style="font-weight:700;">Available now</h5><div style="font-size:1.4rem; color: var(--luna-mid);">{{ $available->count() }}</div></div>
            <div class="card" style="padding: 20px;"><h5 style="font-weight:700;">Upcoming</h5><div style="font-size:1.4rem; color: var(--luna-mid);">{{ $upcoming->count() }}</div></div>
            <div class="card" style="padding: 20px;"><h5 style="font-weight:700;">Completed</h5><div style="font-size:1.4rem; color: var(--luna-mid);">{{ $completed->count() }}</div></div>
            <div class="card" style="padding: 20px;"><h5 style="font-weight:700;">Total Score</h5><div style="font-size:1.4rem; color: var(--luna-mid);">{{ $scores->sum('Score') }}</div></div>
        </div>
