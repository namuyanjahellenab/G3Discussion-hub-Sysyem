...
<div class="page-wrap">
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" onsubmit="syncFullName()">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input id="first_name" class="form-control" type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input id="last_name" class="form-control" type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select id="role" class="form-select" name="role">
                    ...
                    <option value="Lecturer" <?php echo e(old('role') == 'Lecturer' ? 'selected' : ''); ?>>Lecturer</option>
